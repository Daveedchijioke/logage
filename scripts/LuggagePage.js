...
function displayProducts(products) {
  ...
  products.forEach((product) => {
    ...
    productElement.innerHTML = `
      ...
      <p class="rating-value">Rating: <span id="rating-text">0</span>/5</p>
    </div>
        <div class="price-div">
...
// filter for the responsive layout
document.addEventListener("DOMContentLoaded", function () {
   
  document.querySelector('.content-container-btn').addEventListener('click', function() {
